...
If primary sources cannot resolve the contradiction → report to JARVIS with details.
JARVIS escalates to Fury → Hayato if needed.

## JARVIS's Responsibility
...
JARVIS determines the type and includes the appropriate template reference in the task YAML.
